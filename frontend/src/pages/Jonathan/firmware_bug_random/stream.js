// frontend/src/pages/Jonathan/firmware_bug_random/stream.js
...
export default function FirmwareBugRandomStream() {
  ...
  return (
    <div className="container py-4">
      <h3>Live Output for Firmware Bug Random</h3>
      <pre
        style={{
          background: "#000",
          color: "#0f0",
      ...
      {finished && fault && param && label && (
        <div className="mt-4">
          <Link
            href={`/Jonathan/firmware_bug_random/results?fault=${fault}&param=${param}&label=${label}`}
