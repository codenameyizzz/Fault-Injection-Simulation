// frontend/src/pages/Jonathan/mlc_variability/stream.js
"use client";
...
export default function MLcVariabilityStream() {
  ...
  return (
    <div className="container py-4">
      <h3>Live Output for MLC Variability</h3>
      <pre
        style={{
          background: "#000",
          color: "#0f0",
      ...
      {finished && fault && param && label && (
        <div className="mt-4">
          <Link
            href={`/Jonathan/mlc_variability/results?fault=${fault}&param=${param}&label=${label}`}
